...
function nrdb_styles_scripts() {
  ...
  wp_register_style( 'nrdb-icons', 'http://netrunnerdb.com/web/bundles/netrunnerdbbuilder/css/icons.css' );
  wp_register_style( 'nrdb-custom-style', plugins_url( 'NetrunnerDB-for-WordPress/includes/css/style.css' ) );
  ...
  wp_enqueue_style( 'nrdb-custom-style' );
